...
namespace Xperitos.Common.Utils
{
    static public class ObservableBufferMixins
    {
	    ...
	    /// </summary>
	    static public IObservable<IList<T>> Buffer<T>(this IObservable<T> observable, Func<IList<T>, T, bool> closingSelector)
	    {
		    return Observable.Create<IList<T>>(
			    observer =>
			    {
				    ...
				    {
						if (currentBuffer.Count > 0 && closingSelector(currentBuffer, v))
					    {
